...
public class CronTasks {
    ...
    @Autowired
    private AMRSMchEnrollmentService amrsMchEnrollmentService;

    @Autowired
    private  AMRSMchAntenatalService amrsMchAntenatalService;

    @Autowired
    private AMRSMchDischargeAndReferralService amrsMchDischargeAndReferralService;


    @Autowired
    private AMRSMchPostnatalService amrsMchPostnatalService;

    @Autowired
    private AMRSMchDeliveryService amrsMchDeliveryService;
